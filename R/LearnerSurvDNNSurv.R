...
#'
#' @description
#' A [mlr3proba::LearnerSurv] implementing the DNNSurv neural network.
    ...
    initialize = function() {
      ...
      ps <- ParamSet$new(
        params = list(
          ...
          ParamDbl$new("validation_split", default = 0, lower = 0, upper = 2,
                       tags = c("train", "fit")),
      ...
      super$initialize(
        ...
        param_set = ps,
        man = "mlr3learners.proba::mlr_learners_surv.dnn",
